...
"")
        ...
        self.startBtn.setGeometry(QtCore.QRect(230, 100, 141, 61))
        font = QtGui.QFont()
        ...
        self.stopBtn.setGeometry(QtCore.QRect(420, 100, 141, 61))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.openContactorBtn.setGeometry(QtCore.QRect(230, 230, 141, 61))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.closeContactorBtn.setGeometry(QtCore.QRect(430, 230, 141, 61))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(10)
        font.setBold(False)
